...
namespace executor
{
	boost::program_options::options_description setup_options()
	{
		...
		desc.add_options()
            ...
            ("train_instances", boost::program_options::value<unsigned int>()->default_value(500), "Number of training instances")
            ("test_instances", boost::program_options::value<unsigned int>()->default_value(100), "Number of test instances")
